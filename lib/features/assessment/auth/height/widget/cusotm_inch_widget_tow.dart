...
class CustomInchWidget extends StatelessWidget {
  final int value;
  final int selectedValue;

  const CustomInchWidget({
    super.key,
    required this.value,
      ...
      child: Opacity(
        ...
        child: Row(
          ...
          children: [
            ...
            Text('$value',style: textStyle.copyWith(fontSize: fontSize)),
            Text('cm',style: textStyle.copyWith(fontSize: fontSize)),
          ],
        ),
      ),
    );
