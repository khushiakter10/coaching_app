      ...
      appBar: AppBar(
        ...
        leading: Container(
          ...
          child: GestureDetector(
            child: SvgPicture.asset(AppIcons.arrwicon, height: 24.h),
            onTap: () {
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              Text(
                'Du har fått post',
                style: TextFontStyle.textStyle16SatoshiW700.copyWith(fontSize: 24.sp),
              ),
                ...
                children: List.generate(4, (index) {
                  return Container(
                    ...
                    child: TextFormField(
                      ...
                      style: TextFontStyle.headline16c393C43Figtreew500,
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Text('Fick du inte e-post?', style: TextFontStyle.headline14c000000Satoshiw400),
                  UIHelper.horizontalSpace(4.w),
                  GestureDetector(
                    onTap: () {
                    },
                    child: Text( 'Skicka igen',  style: TextFontStyle.headline14cF97316Satoshiw700))])
