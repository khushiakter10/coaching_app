...
class _TrainingScreenState extends State<TrainingScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(padding: EdgeInsets.symmetric(vertical: 24.h, horizontal: 24.w),
        child: Column(
          ...
          children: [
            ...
            Text('Lägg till träning (0)',style: TextFontStyle.headline16000000Figtreew700),
            ...
            CustomButtonWidget(
              ...
              onPressed: () {
                NavigationService.navigateTo(Routes.addScreen);
              },
            )
          ],
        ),
      ...
      bottomNavigationBar: Padding(
        padding: EdgeInsets.only(left: 23.w, right: 23.w, bottom: 25.h),
